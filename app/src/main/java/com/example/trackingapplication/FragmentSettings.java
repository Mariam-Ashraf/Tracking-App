        ...
        save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (truckID_edit_txt.getText().toString().length() == 0 ||
                        ...
                        (Integer.parseInt(truckID_edit_txt.getText().toString()) != FirstActivity.sharedPreferences.getInt("truck_ID", 0) &&
                        FirstActivity.sharedPreferences.getInt("truck_ID", 0) != 0)) {
    ...
    class AsyncT extends AsyncTask<Void, Void, Void> {
            ...
            try {
                ...
                try (BufferedReader read = new BufferedReader(
                    ...
                    if (numberResponse.contains("\"Code\":1")) {
                        ...
                        if (numberResponse.contains("Wrong Truck ID")) {
                            responseCode = -3;
                            FirstActivity.sharedPreferences.edit().putInt("truck_ID", 0).apply();
                        } else {
                            responseCode = -1;
                    ...
                    } else if (numberResponse.contains("\"Code\":3")) {
                        responseCode = 3;
                    } else {
                        responseCode = 0;
                        FirstActivity.sharedPreferences.edit().putBoolean("isFull", false).apply();
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (responseCode == 1) {
                ...
                Toast.makeText(getActivity(), "Wrong Truck ID", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(getActivity(), "Truck Has No Next Location", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(getActivity(), "Error", Toast.LENGTH_SHORT).show();
            }

            if (FirstActivity.sharedPreferences.getBoolean("isSaved", false) && responseCode != -3 && responseCode != 0 && responseCode != 3 ) {
