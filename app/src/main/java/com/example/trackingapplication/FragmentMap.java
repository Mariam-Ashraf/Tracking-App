...
public class FragmentMap extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        if (FirstActivity.sharedPreferences.getBoolean("isFirstLoc", true)) {
            FirstActivity.sharedPreferences.edit().putBoolean("isFirstLoc", false).apply();
        } else {
            mMapView.onResume();
    ...
    class AsyncT extends AsyncTask<Void, Void, Void> {
            ...
            try {
                ...
                try (BufferedReader read = new BufferedReader(
                    ...
                    if (numberResponse.contains("\"Code\":1")) {
                        ...
                        responseCode = -1;
                    } else if (numberResponse.contains("\"Code\":0")) {
                        responseCode = 0;
                    } else {
                        responseCode = 3;
                    }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (responseCode == 1) {
                ...
                Toast.makeText(getActivity(), "Truck Not Active", Toast.LENGTH_LONG).show();
            ...
            if (responseCode == -1 || responseCode == -2 || responseCode == 0 || responseCode == 3) {
                onPause();
